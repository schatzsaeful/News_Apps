...
import com.contoh.newsapps.databinding.MainFragmentEverythingBinding
...
class MainEverythingFragment : BaseFragment(R.layout.main_fragment_everything) {

    private val binding: MainFragmentEverythingBinding by viewBinding()
    private val viewModel: MainEverythingViewModel by fragmentViewModel()
    ...
    private fun subscribeToNewsAsync() {
        viewModel.onEach(
            MainEverythingState::newsListAsync,
            uniqueOnly()
        ) {
            when (it) {
